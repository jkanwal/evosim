...
public class SpawnCreaturesAndFood2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (var i = 0; i < creatureNum; ++i)
        {
            ...
            baby.GetComponent<AntennaSteering>().minSpeed = minimumSpeed;
            baby.GetComponent<AntennaSteering>().maxSpeed = Random.Range(minimumSpeed, maximumSpeed);
            baby.GetComponent<AntennaSteering>().rotationRange = Random.Range(minumumRotation, 120f);
        }
    }
    ...
    //Function to count creature success
    void Reproduction()
    {
