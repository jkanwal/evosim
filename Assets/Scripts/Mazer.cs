...
public class Mazer : MonoBehaviour
{
    ...
    private float noiseFactor = 0.39f;
    ...
    void Start()
    {
        ...
        {
            addFlatMaze(new Vector3(8000+Random.Range(-i * 80, 80 * i ),10000 - (i*10), 4500 + Random.Range(-i * 40.5f, 40.5f * i)));
        }
        ...
        camera.transform.position = new Vector3(8000, 500f, 4500);
